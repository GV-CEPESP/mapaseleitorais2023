...
lvrj_espacial <- lvrj |> 
  ...
  # Transforma para Sirgas2000, com crs == 4674, que e o mesmo do rj_bairros
  st_transform(4674)
```
...
```{r integra-bases-paes, message = FALSE}
...
```{r descritivo-paes, message = FALSE}
...
```{r votos-para-shp-paes, message = FALSE}
