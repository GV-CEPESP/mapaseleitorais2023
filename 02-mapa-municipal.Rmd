...
```{r mostra o mapa de São Paulo, message = FALSE}
...
```{r mostra o mapa de São Paulo com locais de votação, message = FALSE}
ggplot(mapa) + 
  geom_sf() +
  geom_sf(data = lvsp2020) + #adicinando camada com os pontos dos locais de votação
