...
```{r mapa de São Paulo com locais de votação, warning = FALSE}
mapa %>% 
  ggplot() + ## Gera o gráfico
  geom_sf() + ## Transforma em mapa
  geom_sf(data = lvsp2020) + # Adiciona camada com os pontos dos locais de votação
