...
Agora, faremos a visualização de ambos os cortes seguindo a mesma ordem apresentada anteriormente: *jenks* e *geom*.

```{r graficos-jenks-geom, message = FALSE}
...
*****Em boa parte dos casos, porem, voce vai querer criar uma escala, a partir dos resultados observados. No codigo abaixo, criamos uma escala manualmente com intervalos de 5 p.p. em 5 p.p., inciando em 10. Alem disso, incluimos diversos elementos, como titulo, legenda, escala, e rosa dos ventos
